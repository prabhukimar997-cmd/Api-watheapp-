...
app.get("/send", async (req, res) => {
    try {
        ...
        // ============ ✅ YEH FIX HAI ============
        try {
            // Step 1: Presence subscribe karo (first-time interaction ke liye)
            await session.sock.presenceSubscribe(jid);
            await delay(1500);
        } catch (e) {
            // Agar presenceSubscribe fail ho, phir bhi aage badho
            console.log("presenceSubscribe warning:", e.message);
        }
